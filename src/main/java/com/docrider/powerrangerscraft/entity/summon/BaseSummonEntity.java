package com.docrider.powerrangerscraft.entity.summon;

import com.docrider.powerrangerscraft.PowerRangersCraftCore;
import com.docrider.powerrangerscraft.entity.ai.RangedSwordgunAttackGoal;
   ...
   private ListTag REQUIRED_FORMS = new ListTag();
			...
			if (isTame()) {
        		if (p_28879_ instanceof Creeper || p_28879_ instanceof Ghast) {
        		    if (this.getMainHandItem().getItem() instanceof BowItem) {
        		    	...
        		    	|| this.getMainHandItem().is(ItemTags.create(ResourceLocation.fromNamespaceAndPath(PowerRangersCraftCore.MODID, "arsenal/all_swordguns")))) || !this.getMeleeOnly();
					}
					return false;
				}
    ...
    public void reassessWeaponGoal() {
        if (!this.level().isClientSide) {
            ...
            if (itemstack.getItem() instanceof BowItem && !itemstack.is(ItemTags.create(ResourceLocation.fromNamespaceAndPath(PowerRangersCraftCore.MODID, "arsenal/all_swordguns")))) {
