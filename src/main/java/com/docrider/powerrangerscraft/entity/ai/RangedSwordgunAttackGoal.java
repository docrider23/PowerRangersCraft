package com.docrider.powerrangerscraft.entity.ai;
...
public class RangedSwordgunAttackGoal<T extends Mob & RangedAttackMob> extends RangedBowAttackGoal<T> {
    ...
    protected boolean isHoldingSwordgun() {
        return this.mob.isHolding(is -> is.is(ItemTags.create(ResourceLocation.fromNamespaceAndPath(PowerRangersCraftCore.MODID, "arsenal/all_swordguns"))));
    }
