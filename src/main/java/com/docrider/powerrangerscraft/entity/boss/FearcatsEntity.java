...
public class FearcatsEntity extends BaseFootsoldierEntity {

    public FearcatsEntity(EntityType<? extends BaseFootsoldierEntity> type, Level level) {
        super(type, level);
