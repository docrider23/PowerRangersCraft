...
public class GeneralVenjixEntity extends BaseFootsoldierEntity {

    private final ServerBossEvent bossEvent = (ServerBossEvent)(new ServerBossEvent(Component.translatable(getDisplayName().getString()).withStyle(ChatFormatting.DARK_GRAY), BossEvent.BossBarColor.YELLOW, BossEvent.BossBarOverlay.PROGRESS));
    ...
    public GeneralVenjixEntity(EntityType<? extends BaseFootsoldierEntity> type, Level level) {
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(WildForceItems.GENERAL_VENJIX_BELT.get()));
    }
