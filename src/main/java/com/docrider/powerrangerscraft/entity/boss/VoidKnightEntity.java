...
public class VoidKnightEntity extends BaseFootsoldierEntity {
    ...
    public VoidKnightEntity(EntityType<? extends BaseFootsoldierEntity> type, Level level) {
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(DinoFuryItems.VOID_KNIGHT_CHANGER.get()));
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(DinoFuryItems.VOID_SABER.get()));
        this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(DinoFuryItems.DINO_KNIGHT_SHIELD.get()));
    }
