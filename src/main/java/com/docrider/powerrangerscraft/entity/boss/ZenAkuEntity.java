...
public class ZenAkuEntity extends BaseFootsoldierEntity {
    ...
    public static final Item[] weapon = new Item[] {WildForceItems.FLUTE_KNIFE.get(),WildForceItems.CRESCENT_BLADE.get()};

    public ZenAkuEntity(EntityType<? extends BaseFootsoldierEntity> type, Level level) {
        super(type, level);
        NAME="zen_aku";
