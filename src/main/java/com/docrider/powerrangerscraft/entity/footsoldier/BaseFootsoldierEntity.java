...
public class BaseFootsoldierEntity extends Monster implements RangedAttackMob {
    ...
    public String NAME = "shocker_combatmen";
    ...
    public void aiStep() {
        ...
        if (this.getTarget() != null && itemstack.is(ItemTags.create(ResourceLocation.fromNamespaceAndPath(PowerRangersCraftCore.MODID, "arsenal/all_swordguns")))) {
            ...
            if (swordgunMeleeOnly != swordgunMeleeCheck) this.setSwordgunMeleeOnly(swordgunMeleeCheck);
        }
        super.aiStep();
    ...
    public void setSwordgunMeleeOnly(boolean melee) {
        if (this.level() != null && !this.level().isClientSide) {
            if (melee) {
                this.goalSelector.removeGoal(this.bowGoal);
                this.goalSelector.addGoal(2, this.meleeGoal);
