package com.docrider.powerrangerscraft.entity.ally;
...
public class SentinelKnightEntity extends BaseAllyEntity {

	public SentinelKnightEntity(EntityType<? extends SentinelKnightEntity> entityType, Level level) {
		super(entityType, level);
		NAME = "sentinel_knight";
        ...
        if (!this.level().isClientSide || this.isBaby() && this.isFood(itemstack)) {
            if (this.isTame()) {
                if (this.isFood(itemstack) && this.getHealth() < this.getMaxHealth()) {
                    ...
                    if (itemstack.is(OtherItems.POWER_RANGERS_LOGO.get())) {
