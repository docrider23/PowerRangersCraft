...
public class SamuraizerItem extends RangerChangerItem{
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
		...
		if (formItem==SamuraiItems.MEGA_MODE_DISC.get()) {
		...
		else if (formItem==SamuraiItems.SUPER_MEGA_MODE_DISC.get()) {
			tooltipComponents.add(Component.literal("Ranger: " + Component.translatable(formItem.toString() + ".form_1").getString()));
			tooltipComponents.add(Component.literal(Component.translatable(formItem.toString() + ".form_2").getString()));
		}
		else if (formItem==SamuraiItems.MEGA_MODE_DISC_BLUE.get()) {
			tooltipComponents.add(Component.literal("Ranger: " + Component.translatable(formItem.toString() + ".form_1").getString()));
			tooltipComponents.add(Component.literal(Component.translatable(formItem.toString() + ".form_2").getString()));
		}
		else if (formItem==SamuraiItems.SUPER_MEGA_MODE_DISC_BLUE.get()) {
			tooltipComponents.add(Component.literal("Ranger: " + Component.translatable(formItem.toString() + ".form_1").getString()));
			tooltipComponents.add(Component.literal(Component.translatable(formItem.toString() + ".form_2").getString()));
		}
		else if (formItem==SamuraiItems.MEGA_MODE_DISC_PINK.get()) {
			tooltipComponents.add(Component.literal("Ranger: " + Component.translatable(formItem.toString() + ".form_1").getString()));
			tooltipComponents.add(Component.literal(Component.translatable(formItem.toString() + ".form_2").getString()));
		}
		else if (formItem==SamuraiItems.SUPER_MEGA_MODE_DISC_PINK.get()) {
			tooltipComponents.add(Component.literal("Ranger: " + Component.translatable(formItem.toString() + ".form_1").getString()));
			tooltipComponents.add(Component.literal(Component.translatable(formItem.toString() + ".form_2").getString()));
		}
		else if (formItem==SamuraiItems.MEGA_MODE_DISC_GREEN.get()) {
			tooltipComponents.add(Component.literal("Ranger: " + Component.translatable(formItem.toString() + ".form_1").getString()));
			tooltipComponents.add(Component.literal(Component.translatable(formItem.toString() + ".form_2").getString()));
		}
		else if (formItem==SamuraiItems.SUPER_MEGA_MODE_DISC_GREEN.get()) {
			tooltipComponents.add(Component.literal("Ranger: " + Component.translatable(formItem.toString() + ".form_1").getString()));
			tooltipComponents.add(Component.literal(Component.translatable(formItem.toString() + ".form_2").getString()));
		}
		else if (formItem==SamuraiItems.MEGA_MODE_DISC_YELLOW.get()) {
			tooltipComponents.add(Component.literal("Ranger: " + Component.translatable(formItem.toString() + ".form_1").getString()));
			tooltipComponents.add(Component.literal(Component.translatable(formItem.toString() + ".form_2").getString()));
		}
		else if (formItem==SamuraiItems.SUPER_MEGA_MODE_DISC_YELLOW.get()) {
			tooltipComponents.add(Component.literal("Ranger: " + Component.translatable(formItem.toString() + ".form_1").getString()));
			tooltipComponents.add(Component.literal(Component.translatable(formItem.toString() + ".form_2").getString()));
		}
