...
public class ShodoPhoneItem extends RangerChangerItem{
	...
	public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
		...
		if (this==SamuraiItems.PRINCESS_SAMURAIZER.get())
		{
			if (formItem==SamuraiItems.MEGA_MODE_DISC_PRINCESS.get()) {
			...
			else if (formItem==SamuraiItems.SUPER_MEGA_MODE_DISC_PRINCESS.get()) {
				tooltipComponents.add(Component.literal("Ranger: " + Component.translatable(formItem.toString() + ".form_1").getString()));
				tooltipComponents.add(Component.literal(Component.translatable(formItem.toString() + ".form_2").getString()));
			}
