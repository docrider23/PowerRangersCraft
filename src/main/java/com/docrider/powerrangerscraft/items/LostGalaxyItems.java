...
public class LostGalaxyItems {
	...
	public static final DeferredItem<Item> GALACTIC_KEY = ITEMS.register("galactic_key",
			() -> new RangerFormChangeItem(new Item.Properties(),0,"_armored","galaxy_red","lights_of_orion_belt").ChangeSlot(2).ChangeBeltModel("geo/rangerbeltextra.geo.json").AddToTabList(RangerTabs.LOST_GALAXY));
