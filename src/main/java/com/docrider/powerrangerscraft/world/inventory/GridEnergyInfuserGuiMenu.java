...
public class GridEnergyInfuserGuiMenu extends AbstractContainerMenu {
    public final GridEnergyInfuserBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public GridEnergyInfuserGuiMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, RangerBlocks.GRID_ENERGY_INFUSER.get());
    }
